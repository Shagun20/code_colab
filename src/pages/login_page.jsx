                ...
                {(step == 1) && <div className="bg-white/10 backdrop-blur-2xl border border-white/20 p-10 rounded-[2.5rem] w-full max-w-[420px] shadow-2xl flex flex-col items-center gap-8 ">
                    ...
                    <div className="relative w-full">
                        <input
                            ...
                            placeholder="name"
                            className="w-full bg-white/5 border border-white/10 rounded-2xl py-5 text-center text-3xl font-mono text-white tracking-wide outline-none focus:border-white/40 focus:bg-white/10 transition-all placeholder:opacity-20"
                        />
